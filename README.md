...
**Project Structure**
TGDAP\data_raw\           # Raw gravity readings <br>
TGDAP\scripts\            # Processing scripts (Python, AWK, etc.) <br>
TGDAP\docs\               # Technical documentation [available soon] <br>
TGDAP\results\            # reports <br>
